...
public class mainMenuController {
    ...
    public void delete(ActionEvent event) throws IOException {
        if(ProjectList.getSelectionModel().getSelectedItem().getClass() == Main.ProjectsList.getProjectsList().get(0).getClass()){
            ...
            viewhandler.SwitchScenes(event);
        } else if(colleagueList.getSelectionModel().getSelectedItem().getClass() == Main.ColleagueList.getKollegaList().get(1).getClass()){
